...
insert into merchandise(id, name, price, store_id) values (1, 'Роза', 100, 3);
...
values (1, '12.02.2019', 1, 1, 1, 1, 10, 3);
insert into merchandise(id, name, price, store_id) values (2, 'Фиалка', 100, 3);
insert into booking(id, date, address_id, bookingstatus_id, buyer_id, merchandise_id, count, store_id)
values (2, '12.02.2019', 1, 1, 1, 2, 10, 3);